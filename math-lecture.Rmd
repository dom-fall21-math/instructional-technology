...
\begin{align}
    ...
    &\text{X-intercept: } \cssId{Step2-5}{ (0,1)}  \\[3px]
...
\begin{align}
    &\text{Domain: } \cssId{Step3-1}{ (0,\infty)} \\[3px]
    ...
    &\hspace{1cm} \text{As } x \rightarrow \cssId{Step3-4}{ 0 } , \hspace{.25cm} f(x) \rightarrow - \infty \\[3px]
    &\text{X-intercept: } \cssId{Step3-5}{ (0,1)}  \\[3px]
    &\text{Asymptote: } \cssId{Step3-6}{ 0} 
\end{align}
...
\begin{align}
    &\text{Domain: } \cssId{Step4-1}{ (0,\infty)} \\[3px]
    ...
    &\hspace{1cm} \text{As } x \rightarrow \cssId{Step4-4}{ 0 } , \hspace{.25cm} f(x) \rightarrow - \infty \\[3px]
    &\text{X-intercept: } \cssId{Step4-5}{ (0,1)}  \\[3px]
    &\text{Asymptote: } \cssId{Step4-6}{ 0} 
\end{align}
...
\begin{align}
    &\text{Domain: } \cssId{Step5-1}{ (0,\infty)} \\[3px]
    ...
    &\hspace{1cm} \text{As } x \rightarrow \cssId{Step5-4}{ 0 } , \hspace{.25cm} f(x) \rightarrow - \infty \\[3px]
    &\text{X-intercept: } \cssId{Step5-5}{ (0,1)}  \\[3px]
    &\text{Asymptote: } \cssId{Step5-6}{ 0} 
\end{align}
...
\begin{align}
    &\text{Domain: } \cssId{Step6-1}{ (0,\infty)} \\[3px]
    ...
    &\hspace{1cm} \text{As } x \rightarrow \cssId{Step6-4}{ 0 } , \hspace{.25cm} f(x) \rightarrow - \infty \\[3px]
    &\text{X-intercept: } \cssId{Step6-5}{ (0,1)}  \\[3px]
    &\text{Asymptote: } \cssId{Step6-6}{ 0} 
\end{align}
